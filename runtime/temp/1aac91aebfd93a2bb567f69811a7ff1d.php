<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:71:"C:\wamp64\www\admin\public/../application/admin\view\check\inspect.html";i:1530784051;s:69:"C:\wamp64\www\admin\public/../application/admin\view\public\base.html";i:1518166002;s:77:"C:\wamp64\www\admin\public/../application/admin\view\public\admin_load_t.html";i:1518166002;s:74:"C:\wamp64\www\admin\public/../application/admin\view\public\admin_top.html";i:1530085626;s:75:"C:\wamp64\www\admin\public/../application/admin\view\public\admin_left.html";i:1518166002;s:75:"C:\wamp64\www\admin\public/../application/admin\view\public\top_action.html";i:1518166002;s:71:"C:\wamp64\www\admin\public/../application/admin\view\public\search.html";i:1518166002;s:77:"C:\wamp64\www\admin\public/../application/admin\view\public\admin_bottom.html";i:1530085514;s:77:"C:\wamp64\www\admin\public/../application/admin\view\public\admin_load_b.html";i:1518166002;}*/ ?>
                ...
                <div class="box-body table-responsive">
                    <table class="table table-bordered table-hover table-sort">
                        ...
                        <tr>
                            ...
                            <td style="vertical-align:middle"><?php echo $vo['inspect_name']; ?></td>
                            <td style="vertical-align:middle"><?php echo $vo['inspect_phone']; ?></td>
                            <td style="vertical-align:middle"><?php echo $vo['inspect_time']; ?></td>
                            <td style="vertical-align:middle"><?php echo $vo['plate']; ?></td>
                            <td style="vertical-align:middle"><?php if($vo['inspect_type'] == 0 ){ ?>自主送达<?php } else{?>上门取车<?php }?></td>
                            <td style="vertical-align:middle"><img src="<?php echo $vo['img']; ?>" style="width:50px;" /></td>
                            <td style="vertical-align:middle"><?php echo $vo['address']; ?></td>
                            <td style="vertical-align:middle"><?php if($vo['is_invoice'] == 0 ){ ?>不开<?php } else{?>开<?php }?></td>
                            <td style="vertical-align:middle"><?php if($vo['invoice_type'] == 0 ){ ?>无<?php } elseif($vo['invoice_type'] == 1){?>公司<?php }else{?>个人 <?php } ?></td>
                            <td style="vertical-align:middle"><?php echo $vo['invoice_name']; ?></td>
                            <td style="vertical-align:middle"><?php echo $vo['invoice_number']; ?></td>
                            <td style="vertical-align:middle"><?php if($vo['status'] == 0 ){ ?>已预约<?php } elseif($vo['invoice_type'] == 1){?>已取消 <?php } ?> </td>
                            <td style="vertical-align:middle">
                                <?php echo authAction(CONTROLLER_NAME.'/authGroup', 'auth_group', ['id' => $vo['id']]); ?>
                                <?php echo authAction(CONTROLLER_NAME.'/inspect_edit', 'inspect_edit', ['id' => $vo['id']]); ?> 
                                <?php echo authAction(CONTROLLER_NAME.'/inspect_delete', 'inspect_delete', $vo['id']); ?> 
                            </td>
                        </tr>
